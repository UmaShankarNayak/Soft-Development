...
public class CloningExample {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
        ...
        // here city reference is not change still pointing to old one.
        ...
        System.out.println(person1);// here city object is also changing
...
Person [name=Naresh, income=10000, city=City [name=Bhopal]]
